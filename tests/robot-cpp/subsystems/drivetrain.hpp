...
private:
  ...
  ctre::phoenix6::StatusSignal<units::angular_velocity::turns_per_second_t>& m_leftVelocity;
  ctre::phoenix6::StatusSignal<units::angle::turn_t>& m_rightPosition;
  ctre::phoenix6::StatusSignal<units::angular_velocity::turns_per_second_t>& m_rightVelocity;
